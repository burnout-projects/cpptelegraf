...
struct ProtocolTestFixture : testing::Test
{
  ...
  std::unordered_map<std::string, std::string> values_ = { { "first", "80" }, { "second", "100.123" }, { "third", "true" } };
  std::unordered_map<std::string, std::string> tags_ = { { "fourth", "80" }, { "fifth", "100" }, { "sixth", "true" } };
...
{
  std::string expected = "system_stats,sixth=true,fifth=100,fourth=80 third=true,second=100.123,first=80 12345678";
